...
export const colors = {
  ...
  border: primitiveColor.grayE8E5,
  borderStrong: primitiveColor.grayE5,
  accent: primitiveColor.blue2F6BFF,
  action: primitiveColor.cyan08AFD3,
  actionPrimary: primitiveColor.cyan08AFD3,
  actionPrimaryDark: primitiveColor.cyan08A7CA,
  actionPrimaryDarker: primitiveColor.cyan079FC0,
  actionPrimaryHighlight: primitiveColor.cyan08AFD3,
  accentMuted: primitiveColor.blueD9E8FF,
  ...
  cardDark: primitiveColor.gray2B,
  cardLight: primitiveColor.grayD9,
  cardSilver: primitiveColor.grayC4,
  cardSleeve: primitiveColor.gray1414,
  positive: primitiveColor.gray111,
  negative: primitiveColor.gray111,
  notificationBadge: primitiveColor.redFF3B30,
} as const;
