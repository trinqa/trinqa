export const outliers = [
  ...
  },
  {
    ...
    note: 'Multiple near-blacks. merchantLogo now uses #111111; #050505 primitive leftover.',
  },
  {
    id: 'borders',
    values: ['#E5E5E5'],
    note: 'colors.border collapsed into colors.borderStrong. primitive grayE8E5 leftover.',
  },
  {
    id: 'type-off-scale',
    values: ['17'],
  ...
  },
  {
    id: 'unused-accent',
    values: ['#2F6BFF'],
    note: 'primitiveColor.blue2F6BFF unused; not in product colors. CTA stays cyan #08AFD3.',
  },
  {
    id: 'signed-amounts',
    values: ['textPrimary #111111'],
    note: 'Debit and credit amounts share colors.textPrimary. positive/negative aliases removed.',
  },
  {
